...
char character;
void HuffmanUtility::writeHeader(ofstream& outputStream, unordered_map<unsigned char, string> codeMap) {
...
unordered_map<unsigned char, string> HuffmanUtility::readHeader(ifstream& inputStream) {
    //codeMap.clear();
